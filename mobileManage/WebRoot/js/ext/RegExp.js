...
/*<form onSubmit="return Validator.Validate(this,2)" action="" method="post">
<input name="Email" dataType="Email" msg="信箱格式不正确"><br />
...
江西<input name="Province" value="4" type="radio" dataType="Group" msg="必须选定一个省份" ><br/>
...
看书<input name="Favorite" value="4" type="checkbox" dataType="Group" min="2" max="3" msg="必须选择2~3种爱好"><BR />
<input type="submit"  />
</form>*/